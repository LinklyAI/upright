...
const en = {
  ...
  sittingMessage: 'Sitting too long. Stand up and step away for at least {minutes} minutes.',
  blinkMessage: 'Blink your eyes',
  eyeCare: 'Blink reminder',
  issueLookAway: 'Look-away reminder',
  lookAwayMessage: 'Look 6 m away for 20 s',
  lookAwayBreak: 'Look 6 m away · {seconds} s left',
  lookAwayBreakStartedLog: 'Look-away break started; other checks paused for 20 s',
  lookAwayBreakEndedLog: 'Look-away break over; checks resumed',
...
const zh: Record<Key, string> = {
  ...
  issueBlink: '提醒眨眼',
  issueSitting: '久坐',
  sittingMessage: '久坐，请起身活动，离开至少 {minutes} 分钟',
  blinkMessage: '眨眨眼睛',
  eyeCare: '提醒眨眼',
  issueLookAway: '远眺提醒',
  lookAwayMessage: '看看 6 米外，坚持 20 秒',
  lookAwayBreak: '远眺 6 米外 · 还剩 {seconds} 秒',
  lookAwayBreakStartedLog: '远眺开始，其他检测暂停 20 秒',
  lookAwayBreakEndedLog: '远眺结束，检测已恢复',
